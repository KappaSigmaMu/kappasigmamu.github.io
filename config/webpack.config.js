  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        // Absolute imports from src (e.g. @/components, @/hooks)
        '@': paths.appSrc,
    ...
    plugins: [
      ...
      isEnvDevelopment &&
        ...
        new ReactRefreshWebpackPlugin({
          // react-dev-utils' legacy iframe overlay expects a browser `process`
          // global that webpack 5 no longer provides. webpack-dev-server's own
          // client overlay still reports compilation errors.
          overlay: false
        }),
      ...
      useTypeScript &&
        new ForkTsCheckerWebpackPlugin({
          ...
          typescript: {
            ...
            diagnosticOptions: { synctatic: true },
            typescriptPath: resolve.sync('typescript', {
              basedir: paths.appNodeModules
            })
          }
          // TODO: We need to find out if this config still exists and if so, what's the new format
          // reportFiles: [
