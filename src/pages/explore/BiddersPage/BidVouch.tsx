import { web3FromAddress, web3Accounts, web3Enable, web3FromSource } from '@polkadot/extension-dapp'
...
const BidVouch = () => {
  ...
  const { api, keyring, keyringState } = useKusama()
  ...
  useEffect(() => {
    ...
    //web3FromAddress(key.address as string)
    //    web3FromAddress('HS4zACAmEuCCwkSNjP26Y6My8B1RVTy5eZoNW9MbmLaEZA3')
    //      .then(injector => {
    //        debugger
    //        bid?.signAndSend(key.address).then(d => console.log(d))
    //      })
    //
